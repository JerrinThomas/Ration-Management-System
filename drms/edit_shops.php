...
<div class="div1">
    ...
    <input class="input__field input__field--manami" type="text" id="input-34" name="lname" placeholder="<?php echo $row[1]; ?>" value="<?php echo $row[1]; ?>"/>
    <label class="input__label input__label--manami" for="input-34">
      <span class="input__label-content input__label-content--manami">Licensee Name</span>
                ...
                <span class="input input--manami input--filled">
    <input class="input__field input__field--manami" type="text" id="input-33" name="address"  placeholder="<?php echo $row[2]; ?>" value="<?php echo $row[2]; ?>"/>
