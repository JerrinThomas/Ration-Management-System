...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2017 at 05:16 PM
...
(1000000001, 145874587458, 'Karthika Krish', 'Krishnanilayam (H) Kottaramattam  P.O', '', '', 'Kottaramattam', 984562, 145, 105, 40000, 3, 'uploads/index.jpg', 'jpg', 9847513247, 'Kottayam', 3, 100001, 0, 0, 0, 1),
(1000000002, 984125749865, 'Divine Angel', 'Disvansolvis (H) Hrisvasbil P.O Krivasndo', 'Disvansolvis (H) Hrisvasbil P.O Krivasndo', 'Disvansolvis (H) Hrisvasbil P.O Krivasndo', 'Krivasndo', 987452, 24, 145, 15000, 4, 'uploads/image.jpg', 'jpg', 9744254798, 'Kottayam', 1, 100001, 0, 0, 0, 1),
(1000000003, 145874598652, 'Barath Chandran', 'Barathnivas (H) Bharathpuram P.O Kottayam', 'Barathnivas (H) Bharathpuram P.O Kottayam', 'Barathnivas (H) Bharathpuram P.O Kottayam', 'Kottayam', 874125, 47, 148, 57011, 4, 'uploads/index.jpg', 'jpg', 9874577455, 'Kottayam', 2, 100000, 0, 0, 0, 1),
...
(1000000011, 458749865744, 'mmm', 'kkk', '', '', 'kkk', 111, 1111, 1111, 111, 1, 'uploads/index.jpg', 'jpg', 9874652147, 'Kottayam', 2, 100001, 8, 2, 0.5, 0);
...
--
ALTER TABLE `rationcard_holder`
  MODIFY `ration_card_no` bigint(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1000000012;
--
