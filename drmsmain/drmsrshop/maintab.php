                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab2primary">Primary 2
                            <div class="container" style="background-color: #47a3da;
                                                          margin-top: 10%; width: 95%;
                                                          ">
                                <br><br><br><h3 style=" color: #47a3da;
                                    font-size: 80px; 
                                    margin-bottom: 4%; font-family: 'Lato',sans-serif;
                                    font-weight: 200; letter-spacing: 2px;"><center style=" background-color: white; ">Search</center></h3>
                                <center>
